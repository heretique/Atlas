...
#endif // BX_PLATFORM_EMSCRIPTEN || BX_PLATFORM_NAC
...
void MainWindow::paintBGFX()
{
    ...
    bgfx::dbgTextPrintf(0, 4, 0x0f, "GPU %0.6f [ms]", double(stats->gpuTimeEnd - stats->gpuTimeBegin)*1000.0/stats->gpuTimerFreq);
    bgfx::dbgTextPrintf(0, 5, 0x0f, "CPU %0.6f [ms]", double(stats->cpuTimeEnd - stats->cpuTimeBegin)*1000.0/stats->cpuTimerFreq);
    bgfx::dbgTextPrintf(0, 6, 0x0f, "Draw calls: %d", m_dim*m_dim*m_dim);
