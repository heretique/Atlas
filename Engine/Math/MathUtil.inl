...
inline void MathUtil::subtractMatrix(const float *m1, const float *m2,
                                     float *dst) {
  dst[0] = m1[0] - m2[0];
  dst[1] = m1[1] - m2[1];
  dst[2] = m1[2] - m2[2];
...
inline void MathUtil::multiplyMatrix(const float *m1, const float *m2,
                                     float *dst) {
  ...
  std::memcpy(dst, product, MATRIX_SIZE);
}
...
inline void MathUtil::transformVector4(const float *m, float x, float y,
                                       float z, float w, float *dst) {
  dst[0] = x * m[0] + y * m[4] + z * m[8] + w * m[12];
  dst[1] = x * m[1] + y * m[5] + z * m[9] + w * m[13];
  dst[2] = x * m[2] + y * m[6] + z * m[10] + w * m[14];
}

inline void MathUtil::transformVector4(const float *m, const float *v,
                                       float *dst) {
...
inline void MathUtil::crossVector3(const float *v1, const float *v2,
                                   float *dst) {
