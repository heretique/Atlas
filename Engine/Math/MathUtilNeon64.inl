namespace math
{
inline void MathUtil::addMatrix(const float* m, float scalar, float* dst) __attribute__((optnone))
{
    asm volatile(
...
inline void MathUtil::addMatrix(const float* m1, const float* m2, float* dst) __attribute__((optnone))
{
    asm volatile(
        "ld4     {v0.4s, v1.4s, v2.4s, v3.4s},     [%1] 	\n\t"  // M1[m0-m7] M1[m8-m15]
...
inline void MathUtil::subtractMatrix(const float* m1, const float* m2, float* dst) __attribute__((optnone))
{
    asm volatile(
        "ld4     {v0.4s, v1.4s, v2.4s, v3.4s},     [%1]  \n\t"  // M1[m0-m7] M1[m8-m15]
        "ld4     {v8.4s, v9.4s, v10.4s, v11.4s},   [%2]  \n\t"  // M2[m0-m7] M2[m8-m15]
...
inline void MathUtil::multiplyMatrix(const float* m, float scalar, float* dst) __attribute__((optnone))
{
    asm volatile(
        "ld1     {v0.s}[0],         [%2]            \n\t"        // s
...
inline void MathUtil::multiplyMatrix(const float* m1, const float* m2, float* dst) __attribute__((optnone))
{
    asm volatile(
...
inline void MathUtil::negateMatrix(const float* m, float* dst) __attribute__((optnone))
{
    asm volatile(
...
inline void MathUtil::transposeMatrix(const float* m, float* dst) __attribute__((optnone))
{
    asm volatile(
...
inline void MathUtil::transformVec4(const float* m, const float* v, float* dst) __attribute__((optnone))
{
    asm volatile(
        "ld1    {v0.4s}, [%1]     \n\t"                      // V[x, y, z, w]
...
inline void MathUtil::crossVec3(const float* v1, const float* v2, float* dst) __attribute__((optnone))
{
    asm volatile(
        "ld1 {v0.2s},  [%2]           \n\t"
        "ld1 {v0.s}[2],  [%1]           \n\t"
